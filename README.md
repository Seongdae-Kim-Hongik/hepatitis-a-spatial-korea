...
- crude Moran's I = +0.738 (223 graph districts); +0.736 (218 analysed districts); residual Moran's I = +0.212 (count residuals, p < 0.001) and +0.101 (Pearson residuals, p = 0.008); fitted values include the random effects
