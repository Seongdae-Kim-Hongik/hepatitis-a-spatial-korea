# =============================================================================
# Reproducible analysis code (v2.0.4, corrected reproducibility release)
# "Sanitation Infrastructure and Environmental Vulnerability of Hepatitis A
#  Transmission in South Korea, 2020-2024: Nationwide Bayesian Hierarchical
#  Analysis"
# Seongdae Kim, Byung Chul Chun.
# Submitted to JMIR Public Health and Surveillance as an Original Paper. Earlier versions
...
#  * Getis-Ord Gi* local clustering (Figure S2, Multimedia Appendix 2)
#  * Alternative-specification robustness checks (Table S6, Multimedia Appendix 1)
#
...
#     (Table S4, Multimedia Appendix 1)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# [7] Model comparison M1-M6 (Table S1, Multimedia Appendix 1)
# ---------------------------------------------------------------------------
cat("\n## [7] Model comparison (Table S1, Multimedia Appendix 1)\n")
M <- list(
  M1 = base_f,
...
# ---------------------------------------------------------------------------
# [8] Global Moran's I, pre- and post-modelling (Table S3, Multimedia Appendix 1)
# ---------------------------------------------------------------------------
cat("\n## [8] Global Moran's I (Table S3, Multimedia Appendix 1)\n")
...
# ---------------------------------------------------------------------------
# [9] Eight-graph neighbourhood sensitivity (Table S2, Multimedia Appendix 1)
# ---------------------------------------------------------------------------
cat("\n## [9] 8-graph neighbourhood sensitivity (Table S2, Multimedia Appendix 1)\n")
...
# ---------------------------------------------------------------------------
# [10] Getis-Ord Gi* local clustering (Figure S2, Multimedia Appendix 2)
# ---------------------------------------------------------------------------
cat("\n## [10] Getis-Ord Gi* (Figure S2, Multimedia Appendix 2)\n")
...
# ---------------------------------------------------------------------------
# [11] Alternative-specification robustness checks (Table S6, Multimedia Appendix 1)
# ---------------------------------------------------------------------------
cat("\n## [11] Robustness checks (Table S6, Multimedia Appendix 1)\n")
